...
>>>>>>> Update glob, muffin, and CoffeeScript.
      ...
      this.loading();
<<<<<<< HEAD
      return this._doStorageOperation('read', options, __bind(function(err, record) {
=======
...
<<<<<<< HEAD
        ...
        return this._doStorageOperation((creating ? 'create' : 'update'), options, __bind(function(err, record) {
          var _ref6, _ref7;
=======
...
<<<<<<< HEAD
    Model.prototype.destroy = function(options, callback) {
      ...
      this.destroying();
      return this._doStorageOperation('destroy', options, __bind(function(err, record) {
=======
